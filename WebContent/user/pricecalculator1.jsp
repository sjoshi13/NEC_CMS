...
<form method="post" action="../FetchPriceDetails" name="PriceCal" id="PriceCal">
         ...
         <div class="autocomplete">
                      <input name="source" id="source" class="form-control" placeholder="Source City" type="text" /></div>
            <h4>Destination</h4>
            <div class="autocomplete">
            <input name="destination" id="destination" class="form-control" placeholder="Destination City" type="text"/></div>
