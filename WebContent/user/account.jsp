   ...
   if(session.getAttribute("name")==null)
     ...
     %>
	  ...
	  <div class="bg-light lter b-b wrapper-md">
                     <h1 class="m-n font-thin h3">Account Details</h1>
                  </div>
                  </div>
	<!--	<div class="profile_picture" align="middle" style = "padding-top:20px";>
	  ...
	  <div class="container">
            ...
            Connection con = details.getConn();
				...
				while(rs.next())
				{
					%><strong><p><%=rs.getString("name")%></p></strong><br><%
					%><strong><p><%=rs.getString("username")%></p></strong><br><%
					%><strong><p><%=rs.getString("email")%></p></strong><br><%
					%><strong><p><%=rs.getString("password")%></p></strong><br><%
				}
				%></div>
	  </div>
         <!-- main header -->
