...
.profile_picture img{
   ...
   %>
	  ...
	  <div>
		<form  action="updatepass.jsp" method="post" style="padding-top:30px ; padding-left:30px; width:400px ;text-align:center;">
	  ...
	  <div style="padding-left:30px; padding-top:20px" class="w3-bar">
					<button class="w3-button w3-teal">Submit</button>
					</div>
					</form>
					</div>
              <br>
