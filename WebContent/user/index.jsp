	...
	<div class="app app-header-fixed">
		...
		<div class="container w-xxl">
			<div class="outline">
				...
				<div class="m-b-lg">
					<form action="login.jsp?type='user'" class="" id="login_form_admin" name="login_form_admin" autocomplete="off" method="post" accept-charset="utf-8" novalidate="novalidate">
						...
						<div class="m-t-xxl">
							<input id="Login" name="submit" value="Login" class="btn btn-lg btn-primary btn-block" type="submit"><span id="loginmsg" style="display:none"></span>
						</div>
					</form>
			...
			<div class="m-b-lg">
				<p class="text-center "><small>Don't have an account? </small><a href="SignUp.jsp" style="color:Blue"; ><u>SignUp Now</u></p>
                <div class="text-center text-center m-t-sm text-info"><a href="../index.jsp" target="_blank">Back to Website</a></div>
                </div>
                            
				<div class="text-center" ng-include="'tpl/blocks/page_footer.jsp'"></div>
		</div>
