...
<html lang="en" class="">
   ...
   %>
      ...
      <header id="header" class="app-header navbar" role="menu">
         ...
         <div class="navbar-header bg-dark">
            ...
            <a href="../index.jsp" class="navbar-brand" >
                        <span><img src="logo_image.png" height="50%"></span>
                        </a>
            <!-- / brand -->
         </div>
         <!-- / navbar header -->
	  ...
	  <br>
	  <div style="text-align: center; font-size:-webkit-xxx-large; padding-top: 2px; font-family: inherit; text-shadow:2px 2px 2px slategray;">Hello <%out.println(session.getAttribute("name"));%></div>
	  <br>
	  <br>
	  <br>
	  <div style="font-size:23px; padding-top:100px ;padding-left:25px; text-align:left;">
	  From your account dashboard you can view your <a href="my_order.jsp"><u>recent orders</u></a>, manage your shipping and billing address, and edit your password and account details.
	  <div>
               <br>
              <br>
              <br>
