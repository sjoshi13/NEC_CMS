...
<html lang="en" class="">
   ...
   %>
      ...
      <header id="header" class="app-header navbar" role="menu">
         ...
         <div class="navbar-header bg-dark">
            ...
            <!-- brand -->
            <a href="CourierBoyDashboard.jsp" class="navbar-brand" >
                        <span>Courier Boy</span>
                        </a>
            <!-- / brand -->
         </div>
         <!-- / navbar header -->
         ...
         <div class="aside-wrap">
            <div class="navi-wrap">
               ...
               <nav ui-nav class="navi clearfix">
                  <ul class="nav">
                     <li >
                        <a href="CourierBoyDashboard.jsp" class="auto" >
                        <i class="fas fa-flag"></i>
                        <span>Dashboard</span>
                        </a>
                     </li>
                     <li class="">
                        <a href="pick_up_requests.jsp" class="auto" >
                    ...
                    <li class="">
                         <a href="history.jsp" class="active" >
                     ...
                     <li >
                        ...
                        <ul class="nav nav-sub dk">
                           ...
                           <li >
                              <a href="request.jsp">
                              <span>Create re-scheduling request</span>
                              </a>
                           </li>
                           <li >
                              <a href="request.jsp">
                              <span>Create cancellation request</span>
                              </a>
                           </li>
                        </ul>
                     </li>
  ...
  <div class="panel-body">
                      <div class="col-md-12">
                          ...
                          <input class="form-control" type="text" placeholder="Courier ID">
                      </div>
                      <br>
                      <br>
                      <br>
                      <br>
   <label class="radio-inline"><input type="radio" value="">Re-schedule</label>
<label class="radio-inline"><input type="radio" value="">Cancel</label>

               <br>
               <br>
               <div class="modal-footer">
     <center>   <button type="button" class="btn btn-info" data-dismiss="modal">Send</button></center>
      </div>
