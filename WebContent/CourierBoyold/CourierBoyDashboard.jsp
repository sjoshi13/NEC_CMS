   ...
   %>
      ...
      <div class="hbox hbox-auto-xs hbox-auto-sm">
         ...
         <div class="bg-light lter b-b wrapper-md">
            <h1 class="m-n font-thin h3">Dashboard Welcome ${name}</h1>
         </div>
         <!-- / main header -->
                     ...
                     <div class="row row-sm text-center">
                        <div class="col-xs-6" id="section_tile1">
                           <div class="panel padder-v item">
                              ...
                              <span class="text-muted text-xs">Total Consignments</span>
                        ...
                        <div class="col-xs-6" id="section_tile2">
                           <div class="panel padder-v item bg-primary">
                              ...
                              <span class="text-muted text-xs">Delivery Requests</span>
                              <div class="top text-right w-full">
                                 <div class="dropdown">
                                    <div data-toggle="dropdown" aria-expanded="false"> <i class="fas fa fa-cog fa-spin"></i> </div>
                        ...
                        <div class="col-xs-6" id="section_tile3">
                           <div class="panel padder-v item bg-info">
                              ...
                              <span class="text-muted text-xs">Pick-up history</span>
                              <div class="top text-right w-full">
                                 <div class="dropdown">
                                    <div data-toggle="dropdown" aria-expanded="false"> <i class="fas fa fa-cog fa-spin"></i> </div>
                        ...
                        <div class="col-xs-6" id="section_tile4">
                           <div class="panel padder-v item">
                              ...
                              <span class="text-muted text-xs">Pick-up requests</span>
                              <div class="top text-right w-full">
                                 <div class="dropdown">
                                    <div data-toggle="dropdown" aria-expanded="false"> <i class="fas fa fa-cog fa-spin"></i> </div>
