...
<html lang="en" class="">
  ...
  <div class="panel-body">
                      <div class="col-md-12">
                          <input class="form-control" id="myInput" type="text" placeholder="Filter Bookings...">
                      </div>
...
<div class="modal" id="myModal">
  <div class="modal-dialog">
    <div class="modal-content">
     ...
     <center>   <button type="button" class="btn btn-danger" data-dismiss="modal">Submit</button></center>
      </div>
