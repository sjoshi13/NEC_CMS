         ...
         <div class="app-content-body ">
            <div class="hbox hbox-auto-xs hbox-auto-sm">
               ...
               <div class="bg-light lter b-b wrapper-md">
                  <h1 class="m-n font-thin h3">Pickup Requests</h1>
               </div>
               <!-- / main header -->
                           ...
                           <table st-table="rowCollectionBasic" class="table table-bordered table-striped">
                              ...
                              if(rs==null)
                                ...
                                while(rs.next())
                                {
                                   ...
                                   <%
                                   System.out.print("hereee stat: "+rs.getString("status")+" un "+session.getAttribute("username"));
                                   if((rs.getString("status")).equals("pending") && rs.getString("sender_admin").equals(session.getAttribute("username"))){
                                         ...
                                         <div class="row">
                                            <div>
                                             ...
                                             <form name="frm" method="post" action="updatingDatabase.jsp"> 
                                               ...
                                               <select name="statuss">   
                                                  <option id="a" >--</option>
                                                  <option id="a" value="Assigned">Assigned</option>
                                                  <option id="b" value="Picked-up">Picked-up</option>
                                            ...
                                            <div>
                                             ...
                                             <input type="text" name ="name"  value="<%=rs.getString("sender_agent")%>"/>
