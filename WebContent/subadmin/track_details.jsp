                              ...
                              while(rs.next())
                                 {
                                    ...
                                    %>
                                    <tr><td><%=rs.getInt("bookingID") %></td>
                                      <td><%=rs.getString("track_details")%></td>
                                      ...
                                      <td>
                                         <div class="row">
                                          ...
                                          <form name="frm" method="post" action="updateTracking.jsp" > 
                                             <label>Add Tracking Details:</label>
                                          ...
                                          <div>
                                             ...
                                             <input type="text" value="" name="track" id="track">
                                             <input type="hidden" value="<%=rs.getInt("bookingID")%>" name="id">
