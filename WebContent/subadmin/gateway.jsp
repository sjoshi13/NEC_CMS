      ...
      <div id="content" class="app-content" role="main">
         <div class="app-content-body ">
            <div class="bg-light lter b-b wrapper-md">
               <h1 class="m-n font-thin h3">Add Gateway</h1>
            </div>
                  ...
                  <div class="container">
                     <div class="row">
                        <div class="col-sm-6 text-center">
                           <h4><strong>Enter Gateway Name:</strong></h4><br>
                           <h4><strong>Upload Scanner:</strong></h4>
                        </div>
                        <div class="col-sm-6">
                          <input type="text" id="gateway"><br><br><br>
