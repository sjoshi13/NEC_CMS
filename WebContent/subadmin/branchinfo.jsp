      ...
      <div id="content" class="app-content" role="main">
         <div class="app-content-body ">
            <div class="bg-light lter b-b wrapper-md">
               <h1 class="m-n font-thin h3">Branch</h1>
            </div>
                  ...
                  <div class="container">
                     <div class="row">
                        <div class="col-md-6 text-center">
                          ...
                          <br>
                          <strong><h4> City: </h4></strong><br>
                          <strong><h4> Pincode: </h4></strong><br>
                          <strong><h4> Total delivery agents: </h4></strong><br>
                          <strong><h4> Total employees: </h4></strong><br>
                          <strong><h4> Contact: </h4></strong><br>
                       </div>
                       <div class="col-md-6 ">
                         <strong><h4> Joshi Courier Service</h4></strong><br>
                         <strong><h4> karol bagh </h4></strong><br>
                         <strong><h4> Lucknow </h4></strong><br>
                         <strong><h4> 808080 </h4></strong><br>
                         <strong><h4> 5 </h4></strong><br>
                         <strong><h4> 2 </h4></strong><br>
                         <strong><h4> 9832-323-345 </h4></strong><br>
                      </div>
                   </div>
                </div>
             </div>
