...
<body style= "background-image : url('login_image.jpg');" onload="noBack();"
...
<div class="app app-header-fixed">
	...
	<div class="container w-xxl">
		<div class="outline">
			...
			<div class="text-center" style='font-size:28px;margin-top:5%;color:#5b599e;font-family:inherit;text-shadow: 5px 5px 3px #d2caca;'><b>Sub Admin Login</b></div>
			<div class="m-b-lg">
				<form action="login.jsp" class="" id="login_form_admin" name="login_form_admin" autocomplete="off" method="post" accept-charset="utf-8" novalidate="novalidate">
					...
					<div class="list-group form-group">
						<div class="list-group-item">
							<input name="name" id="name" autocomplete="Off" size="32" maxlength="128" placeholder="Username" class="form-control no-border" type="text">
						</div>
						<div class="list-group-item form-group">
							<input name="password" id="password" size="32" maxlength="32" placeholder="Password" class="form-control no-border password" type="password">
						</div>
					</div>
					<div class="m-t-xxl">
	...
	<!--		<div class="m-b-lg">
				<p class="text-center "><small>Don't have an account? </small><a href="signup.html" style="color:Blue"; ><u>SignUp Now</u></p>
