...
<!-- mysql> create table bookings(
    ...
    -> courier_boy VARCHAR(50),
    -> OTP INT(4), PRIMARY KEY(bookingID)); -->
    <!-- 
    pending
    Assigned
    picked-up
         ...
         <div class="hbox hbox-auto-xs hbox-auto-sm">
            ...
            <div class="wrapper-md">
               <div class="col">
                     ...
                     <div class="col-lg-6 col-md-12" id="section_tile">
                        <div class="row row-sm text-center">
                           ...
                           <div class="col-xs-6" id="section_tile4">
                              <div class="panel padder-v item">
                                 <div class="font-thin text-info h1" id="mail_total">4</div>
                  ...
                  <input type="hidden" id="todo_picked_percent" value="25">
                  <input type="hidden" id="todo_shipped_percent" value="50">
                  <input type="hidden" id="todo_out_percent" value="30">
                  <input type="hidden" id="todo_delivered_percent" value="15">
                  <div class="col-md-12">
                     <div class="row row-sm">
                        <div class="col-xs-3 text-center">
                           <div id="todo_picked" class="inline m-t">
                              <div><span class="text-primary h4">25%</span></div>
                           </div>
                           <div class="text-muted font-bold text-base m-t m-b">Picked</div>
                        </div>
                        <div class="col-xs-3 text-center">
                           <div id="todo_shipped" class="inline m-t">
                              <div> <span class="text-info h4">50%</span> </div>
                           </div>
                           <div class="text-muted font-bold text-base m-t m-b">Shipped</div>
                        </div>
                        <div class="col-xs-3 text-center">
                           <div id="todo_out" class="inline m-t">
                              <div><span class="text-primary h4">30%</span></div>
                           </div>
                           <div class="text-muted font-bold text-base m-t m-b">Out for delivery</div>
                        </div>
                        <div class="col-xs-3 text-center">
                           <div id="todo_delivered" class="inline m-t">
                              <div><span class="text-primary h4">15%</span></div>
                           </div>
                           <div class="text-muted font-bold text-base m-t m-b">Delivered</div>
                        </div>
                     </div>
                  </div>
               </div>
                     ...
                     <div class="row">
                        ...
                        <div class="col-md-3">
                           <ul class="social">
                              ...
                              <span class="m-t-sm">
                                 <div class="font-bold " href="" target="_blank">+91 8853-933-397</div>
                              </span>
                           </ul>
                        </div>
                        <div class="col-md-3">
                           <ul class="social">
                              ...
                              <span class="m-t-sm">
                                 <h6><strong>sssss@gmail.com</strong></h6>
                              </span>
                           </ul>
                        </div>
                     </div>
