<!-- 
Picked-up-> in-transit and CB null
in-transit-> assigned CB
            ...
            <div class="navi-wrap">
               ...
               <nav ui-nav class="navi clearfix">
                  <ul class="nav">
                     ...
                     <li class="active">
                        <a href="courier.jsp" class="auto" >
                           <i class="fas fa-address-card"></i>
                           <span>Couriers</span>
                        </a>
                     </li>
                     <li >
                        <a href="branchinfo.jsp" class="auto" >
         ...
         <div class="app-content-body ">
            <div class="hbox hbox-auto-xs hbox-auto-sm">
               ...
               <div class="bg-light lter b-b wrapper-md">
                  <h1 class="m-n font-thin h3">Delivery Requests</h1>
               </div>
               <!-- / main header -->
                              ...
                              while(rs.next())
                                 {
                                    ...
                                    if(rs.getString("sender_admin").equals(session.getAttribute("username"))){
                                    %>

                                    <tr><td><%=rs.getInt("booking_id")%></td>

                                     <td><%=rs.getString("sender_email")%></td>
                                     <td><%=rs.getString("source_city")%></td>
                                     <td><%=rs.getString("receiver_city")%></td>
                                     ...
                                     <td>
                                      <div class="row">
                                       ...
                                       <form name="frm" method="post" action="updatingDatabase.jsp" > 
                                          ...
                                          <select name="statuss">   
                                           <option id="b" value="Out-for-delivery">--</option>
                                           <option id="b" value="out-for-delivery">out-for-delivery</option>
                                           <option id="b" value="in-transit">in-transit</option>
                                           <option id="b" value="delivered">delivered</option>
                                           <option id="c" value="Cancelled">Cancelled</option>
                                           <option id="d" value="Re-scheduled">re-scheduled</option>
                                        </select>
                                        <br>
                                        <label>Date:</label>
                                     ...
                                     <div>
                                        <label>Courier Boy Name:</label>
                                        


                                        <input type="text" value="<%=rs.getString("sender_agent")%>" name="name">
                                        <input type="hidden" value="<%=rs.getInt("booking_id")%>" name="id">
                                        <input type="hidden" value="" name="hiddenStatus" id="hiddenStatus">
                               ...
                               <td>
                                <form method="post" action="setOTP.jsp" >
                                   <input type="hidden" value="<%=rs.getInt("booking_id")%>" name="id">
                                   <input type="text" name="OTP" value="<%=rs.getString("OTP")%>">
            ...
            <div class="panel no-border">
               <div class="wrapper-md">
                  ...
                  <div class="row">
                     <div class="col-md-3">
                        <ul class="social">
                           <li><a href="#">  <i class="fab fa-gofore"></i> </a> </li>
                           <span class="m-t-sm"> <a class="font-bold " href="index.jsp" target="_blank">Gofer</a>
                           </span>
                        </ul>
                     </div>
                     <div class="col-md-3">
                        <ul class="social">
                           ...
                           <span class="m-t-sm">
                              <div class="font-bold " href="" target="_blank">Linked in</div>
                           </span>
                        </ul>
                     </div>
                     <div class="col-md-3">
                        <ul class="social">
                           ...
                           <span class="m-t-sm">
                              <div class="font-bold " href="" target="_blank">+91 8853-970-397</div>
                           </span>
                        </ul>
                     </div>
                     <div class="col-md-3">
                        <ul class="social">
                           ...
                           <span class="m-t-sm">
                              <h6><strong>shrutijoshi03@gmail.com</strong></h6>
                           </span>
                        </ul>
                     </div>
                  </div>
